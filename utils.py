...
def main():
    ...
    print(get_float_from_money('2\xa0365,01',True)==-2365.01)
    ...
    print('*** testing function split_Sberbank_line()')
    line='                                        19.08.2019                YANDEX.DRIVE                                                    234,05           10 950,18'
    print(split_Sberbank_line(line)==['19.08.2019', 'YANDEX.DRIVE', '234,05', '10\xa0950,18'])

    line='                                          20.08.2019 / 210002       Автомобиль'
    print(split_Sberbank_line(line)==['20.08.2019 / 210002', 'Автомобиль'])
