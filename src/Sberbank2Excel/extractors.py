...
from .extractor_SBER_CREDIT_2110 import SBER_CREDIT_2110
...
from .extractor_SBER_DEBIT_2510 import SBER_DEBIT_2510
extractors_list.append(SBER_DEBIT_2510)

from .extractor_SBER_PAYMENT_2510 import SBER_PAYMENT_2510
extractors_list.append(SBER_PAYMENT_2510)

from .extractor_SBER_CREDIT_2511 import SBER_CREDIT_2511
extractors_list.append(SBER_CREDIT_2511)

from .extractor_SBER_DEBIT_2603 import SBER_DEBIT_2603
extractors_list.append(SBER_DEBIT_2603)

from .extractor_SBER_PAYMENT_2604 import SBER_PAYMENT_2604
extractors_list.append(SBER_PAYMENT_2604)

from .extractor_SBER_SAVING_2604 import SBER_SAVING_2604
...
from .extractor_VTB_PAYMENT_DEBIT_0000F import VTB_PAYMENT_DEBIT_0000F
extractors_list.append(VTB_PAYMENT_DEBIT_0000F)
