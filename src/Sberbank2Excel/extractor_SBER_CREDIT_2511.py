...
class SBER_CREDIT_2511(Extractor):
    ...
    ---------------------------------------------------------------------------------------------------------
        ...
        result['remainder_account_currency'] = get_decimal_from_money(line_parts[4], False)
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        ...
        extractors_generic.debug_extractor(SBER_CREDIT_2511,
