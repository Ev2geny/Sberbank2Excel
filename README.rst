...
3. Добавить новый формат выписки самостоятельно используюя инструкцию разработчика `CONTRIBUTING.md <CONTRIBUTING.md>`_.
...
На данный момент эта утилита не генерируется в exe файл в `регулярных релизах <https://github.com/Ev2geny/Sberbank2Excel/releases/latest>`_ . Необходимо либо сгенерировать её самостоятельно либо запускать из среды Python (см. `CONTRIBUTING.md <CONTRIBUTING.md>`__)
