...
.. csv-table:: 
   ...
   Сбербанк, TODO,  "Выписка из лицевого счёта по вкладу «Сберегательный счет» образца июля 2024 года (ТДВФН). Также должно работать с другими типами сберегательных счетов (Активное долголетие и т.д.)", НП,НП,НП,
   ...
   Сбербанк, TODO,  "Дебетовая карта образца августа 2024 года",  "OK", ???, ОК,
