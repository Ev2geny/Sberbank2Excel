...
.. csv-table:: 
   ...
   Сбербанк, `SBER_PAYMENT_2208 </misc/format_examples/SBER_PAYMENT_2208.png>`__,  "Выписка по платёжному счёту образца августа 2022 года (точное время запуска формата выписки неизвестно)", НП,НП,НП? ,  
