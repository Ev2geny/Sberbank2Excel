...
-   Работает на Windows, а начиная с релиза 5.0.0 также досупна относительно простая установка на macOS и Linux
...
1.  Установите Sberbank2Excel из исходного года:   
    ```
    uv tool install git+https://github.com/Ev2geny/Sberbank2Excel.git
    ```
1.  Убедитесь, что установка прошла успешно, для этого запустите приложение из сомандной строки
