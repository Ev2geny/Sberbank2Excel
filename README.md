...
1.  Попробуйте запустить пиложение из командной строки в графическом режиме
    ...
    sberbank2Excel
    ```
    Прим.: в некоторых случаях пользователи сообщают о [проблемах запуска программы в режиме ГИП](https://github.com/Ev2geny/Sberbank2Excel/issues/74). 
...
Если со времени изначальной установки вышла новая версия Sberbank2Excel, то изначальную установку можно обновить используя команду
