...
- [Установка](#установка)
  - [Опция 1: В виде готового файла, для "чайников" (пока что доступна только для Windows)](#опция-1-в-виде-готового-файла-для-чайников-пока-что-доступна-только-для-windows)
  - [Опция 2: Используя исходный код, для продвинутых (должна работать на всех платформах)](#опция-2-используя-исходный-код-для-продвинутых-должна-работать-на-всех-платформах)
...
- [Приложения](#приложения)
  ...
  - [Приложение Г. Установка используя инструменты python.](#приложение-г-установка-используя-инструменты-python)
...
### Опция 1: В виде готового файла, для "чайников" (пока что доступна только для Windows)
...
### Опция 2: Используя исходный код, для продвинутых (должна работать на всех платформах)

См. [Приложение Г. Установка используя инструменты python.](#приложение-г-установка-используя-инструменты-python)
...
### Приложение Г. Установка используя инструменты python.

1.  Установить [python](https://python.org) версии 3.12 или выше для вашей операционной системы.  
Прим.: для Ubuntu Linux установка python детально описана в  [инстукции разработчика](CONTRIBUTING.md)
1.  Установить утилиту [pipx](https://pipx.pypa.io/stable/installation/) для вашей операционной системы.   
    Например:   
    ```
    python312 -m pip install pipx
    ```

1.  Установить Sberbank2Excel из исходного года:   
