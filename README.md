...
Данная установка более сложная, но должна работать для любой среды (Windows, macOS, Linux)


#### Вариант "Изначальная установка"

1.  Установите [uv](https://docs.astral.sh/uv/getting-started/installation/#installation-methods) 
...
```
python3.12 -m pipx reinstall Sberbank2Excel
```

#### Проверка установки

1.  Проведите пробный запуск утилиты `sberbankPDF2Excel` из командной строки:   
    ```
    sberbankPDF2Excel
    ```
1.  Проведите пробный запуск варианта утилиты с графическим интерфейсом `sberbankPDF2ExcelGUI` из командной строки:   
    ```
