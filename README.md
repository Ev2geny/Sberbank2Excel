...
**Шаг 1** Запустите `sberbankPDF2ExcelGUI.exe` двойным щелчком мыши.  
...
то необходимо из командной строки ввести команду   ```sberbankPDF2ExcelGUI```
...
то помимо графического интерфейса пользователя, доступен способ использования утилиты из комантдной строки.  
...
1.  Установите пакет [pipx](https://pipx.pypa.io/stable/installation/).   
    ...
    ```
1. Проверьте установку pipx
   ```
   python3.12 -m pipx -h
   ```
2.  Установите Sberbank2Excel из исходного года:   
    ```
    python3.12 -m pipx install git+https://github.com/Ev2geny/Sberbank2Excel.git
    ```
